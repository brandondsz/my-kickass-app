...
export class SellersSection extends Component {
  render() {
    return (
        ...
        <div className="container-fluid">
          ...
          <div className="row">
            <div className="col-sm-6 cat-box">
              <div id="dvYoutube">
              <iframe style={{width: '100%', height: '400px'}} src='https://www.youtube.com/embed/IyucJZev9wM' frameBorder='0' webkitallowfullscreen='true' mozallowfullscreen='true' allowFullScreen={true}></iframe>
              </div>
            </div>
            <div className="col-sm-6 cat-box">
